...
<LazySection rootMargin="300px">
  ...
  {(isNear) => (
    ...
    >
          ...
          <div style={{ 
            ...
            background: "rgba(0,0,0,0.2)"
             ...
             <div style={{ 
                ...
                border: "1px solid rgba(255,255,255,0.4)", display: "flex", 
                alignItems: "center", justifyContent: "center",
      ...
      <style>{`
        .video-hover-effect img { transition: transform 1.2s cubic-bezier(0.165, 0.84, 0.44, 1); }
        .video-hover-effect:hover img { transform: scale(1.04); }
      `}</style>
    </section>
  )}
</LazySection>
